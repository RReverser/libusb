...
// TODO: update this after Emscripten 3.1.50 which makes subclassing of the
// awaitables easier and will allow CaughtPromise to return PromiseResult
// from its co_await operator directly.
//
